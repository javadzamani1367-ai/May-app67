...
object SyncPayload {
    ...
    fun report(detail: ReportDetail): JSONObject {
        ...
        json.put("tap_point", r.tapPoint)
        json.put("phase_type", r.phaseType)
        json.put("amperage_r", r.amperageR)
        json.put("amperage_s", r.amperageS)
        json.put("amperage_t", r.amperageT)
        json.put("voltage_r", r.voltageR)
        json.put("voltage_s", r.voltageS)
        json.put("voltage_t", r.voltageT)
        json.put("total_watt", r.totalWatt)
        json.put("tariff_type", r.tariffType)
        json.put("meter_type", r.meterType)
        json.put("seal_external", r.sealExternal)
        json.put("seal_external_serial", r.sealExternalSerial)
